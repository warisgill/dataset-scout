...
may be reported to the maintainers via a [private security
advisory](https://github.com/mdressman/dataset-scout/security/advisories/new)
(the same channel as security reports — it's the only private channel
the repo exposes). All complaints will be reviewed and investigated
promptly and fairly.
